                                    ...
                                    <div className="growth-block-two">
                                        <div className="inner-box">
                                            ...
                                            <ul className="list-item clearfix">
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Currency Pairs</Link></li>
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Real-time Quotes</Link></li>
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Market Analysis</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="growth-block-two">
                                        <div className="inner-box">
                                            ...
                                            <ul className="list-item clearfix">
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Currency Options</Link></li>
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Best Rates</Link></li>
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Secure Transactions</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="growth-block-two">
                                        <div className="inner-box">
                                            ...
                                            <ul className="list-item clearfix">
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Equity Funds</Link></li>
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>International Funds</Link></li>
                                                <li><Link href="/index-2"><img src="assets/images/icons/icon-139.png" alt=""/>Index Funds</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </SwiperSlide>

...
export default function Card_Details_Two() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Millinnia Card">
                            ...
                            <div className="cards-sidebar pt_110 pb_120">
                                <div className="category-widget mb_30">
                                    ...
                                    <ul className="category-list clearfix">
                                        ...
                                        <li><Link href="/card-details-2" className="current">Millinnia Card</Link></li>

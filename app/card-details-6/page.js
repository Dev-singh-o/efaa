...
export default function Card_Details_Six() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Titanium Times">
                            ...
                            <div className="cards-sidebar pt_110 pb_120">
                                <div className="category-widget mb_30">
                                    ...
                                    <ul className="category-list clearfix">
                                        ...
                                        <li><Link href="/card-details-6" className="current">Titanium Times</Link></li>
                                    </ul>
                                </div>

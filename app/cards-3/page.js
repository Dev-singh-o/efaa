...
export default function Cards_Three() {

    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Debit Card">
                        ...
                        <div className="col-lg-9 col-md-12 col-sm-12 content-side">
                            <div className="content-box">
                                <div className="cards-block-one">
                                    <div className="inner-box">
                                        <div className="cards-column">
                                            <h3><Link href="/card-details">Platinum Debit Card</Link></h3>
                                ...
                                <div className="cards-block-one">
                                    <div className="inner-box">
                                        <div className="cards-column">
                                            <h3><Link href="/card-details-2">Millinnia Debit Card</Link></h3>
                                ...
                                <div className="cards-block-one">
                                    <div className="inner-box">
                                        <div className="cards-column">
                                            <h3><Link href="/card-details-3">Money Back Debit Card</Link></h3>
                                ...
                                <div className="cards-block-one">
                                    <div className="inner-box">
                                        <div className="cards-column">
                                            <h3><Link href="/card-details-4">Easy EMI Debit Card</Link></h3>
